...
var VuexSearch = function () {
  ...
  (0, _createClass3.default)(VuexSearch, [{
    ...
    value: function registerResource(resourceName, config) {
      ...
      this._searchSubscribeIfNecessary(searchApi, resourceName, function (_ref4) {
        var result = _ref4.result,
            text = _ref4.text;

        _this2._store.dispatch('' + namespace + actionTypes.RECEIVE_RESULT, {
          result: result, resourceName: resourceName, text: text
        });
      });

      this.reindex(resourceName);

      var initialSearchString = this._getSearchText(resourceName);
